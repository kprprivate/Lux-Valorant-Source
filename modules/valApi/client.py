...
class Client:
    ...
    def __init__(self):
        ...
        # https://github.com/techchrism/valorant-api-docs/blob/6fd25a0ef8807d473a7d13a59b549260d98affa1/docs/common-components.md#client-platform
        ...
        self.lockfile_path = os.path.join(os.getenv('LocalAppData'), 'Riot Games', 'Riot Client', 'Config', 'lockfile')
        self.shootergamefile_path = os.path.join(os.getenv('LocalAppData'), 'VALORANT', 'Saved', 'Logs', 'ShooterGame.log')

    def activate(self) -> None:
        threading.Thread(target=self.activating).start()

    def activating(self) -> None:
    ...
    def get_region(self) -> str:
        pattern = r'https://glz-(?P<region>[a-zA-Z0-9]+)-\d+'
        with open(self.shootergamefile_path, 'r', encoding="utf8") as file:
            for line in file:
